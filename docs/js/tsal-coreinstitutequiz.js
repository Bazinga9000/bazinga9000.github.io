(() => {
  ...
  var nextQuestion = function(st) {
    return {
      questionNumber: function() {
        ...
        ;
        if (st.questionNumber instanceof QNum) {
          var $19 = (st.questionNumber.value0 + 1 | 0) === length4(questions);
          if ($19) {
            return ShowResults.value;
          }
          ;
  ...
  var applyAnswer = function(n) {
    return function(a2) {
      return function(st) {
        var v = bind5(index2(questions)(n))(function(q2) {
  ...
  var renderResult = function(r) {
    ...
    return div2([style("text-align: center;")])([h2(colorstyle)([text5(r.name)]), img([src9("/resources/tsal/coreinstitutequiz/" + r.svg_path), style("width: 10%; height: auto")]), h4(colorstyle)([i_([text5(r.motto)])]), p([style("display: inline-block; width: 40%; align: center; line-height: 1.3")])([text5(r.desc)])]);
  };
  var renderResults = function(state3) {
    ...
    var scoreTable = map17(function(t) {
      return p_([text5(snd(t).name + (": " + show2(fst(t))))]);
    })(weightResults);
    var first = function() {
      var v = head2(weightResults);
      if (v instanceof Just) {
        return snd(v.value0);
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Tsal.CoreInstituteQuiz.RootComponent (line 46, column 17 - line 48, column 35): " + [v.constructor.name]);
    }();
    return div2([style("text-align: center;")])([h2_([text5("Your Core Institute Amalgam is")]), renderResult(first), br_, h3_([text5("Scores")]), div2([style("text-align: center;")])(scoreTable), button([onClick(function(v) {
      return ShowAll.value;
    })])([text5("Show All Amalga")])]);
  };
  ...
  var renderQuestionNumber = function(n) {
    var v = index2(questions)(n);
    if (v instanceof Nothing) {
      return div2([style("text-align: center;")])([h1_([text5("E: No Question " + show2(n + 1 | 0))])]);
    }
    ;
    if (v instanceof Just) {
      return div2([style("text-align: center;")])(append12([h3_([text5(v.value0.question)]), br_, button([onClick(function(v1) {
        return Back.value;
      })])([text5("Return to Previous Question")]), br_, br_])(concatMap(function(x) {
        return renderAnswerButton(fst(x));
      })(fromFoldable4(v.value0.answers))));
    }
    ;
    throw new Error("Failed pattern match at Tsal.CoreInstituteQuiz.RootComponent (line 53, column 26 - line 61, column 82): " + [v.constructor.name]);
  };
  ...
  })])([/* @__PURE__ */ text5("Return to your results.")]), br_])(/* @__PURE__ */ map17(renderResult)(results)));
  var render = function(state3) {
    ...
    ;
    throw new Error("Failed pattern match at Tsal.CoreInstituteQuiz.RootComponent (line 30, column 16 - line 33, column 32): " + [state3.questionNumber.constructor.name]);
  };
    ...
    return function(v) {
      if (v instanceof RegisterAnswer) {
        return modify_3(function(st) {
          ...
          ;
          throw new Error("Failed pattern match at Tsal.CoreInstituteQuiz.RootComponent (line 84, column 42 - line 87, column 52): " + [st.questionNumber.constructor.name]);
        });
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Tsal.CoreInstituteQuiz.RootComponent (line 83, column 16 - line 92, column 68): " + [v.constructor.name]);
    };
  };
