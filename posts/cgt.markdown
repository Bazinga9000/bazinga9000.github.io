...
* *Winning Ways* often expresses sums using concatenation, for example writing $\star\up$ to represent $\star + \up$. This series will not do that for clarity, always expressing sums using the plus sign.
