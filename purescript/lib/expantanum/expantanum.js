...
// purescript exports
// constants
export const _zero = ExpantaNum.ZERO;
export const _one = ExpantaNum.ONE;
export const _eulers = ExpantaNum.E;
export const _ln2 = ExpantaNum.LN2;
export const _ln10 = ExpantaNum.LN10;
export const _log2Eulers = ExpantaNum.LOG2E;
export const _log10Eulers = ExpantaNum.LOG10E;
export const _pi = ExpantaNum.PI;
export const _sqrtOneHalf = ExpantaNum.SQRT1_2;
export const _sqrt2 = ExpantaNum.SQRT2;
export const _maxSafeInteger = ExpantaNum.MAX_SAFE_INTEGER;
export const _minSafeInteger = ExpantaNum.MIN_SAFE_INTEGER;
export const _NaN = ExpantaNum.NaN;
export const _negativeInfinity = ExpantaNum.NEGATIVE_INFINITY;
export const _infinity = ExpantaNum.POSITIVE_INFINITY;
export const _eMaxSafeInteger = ExpantaNum.E_MAX_SAFE_INTEGER;
export const _eeMaxSafeInteger = ExpantaNum.EE_MAX_SAFE_INTEGER;
export const _tetratedMaxSafeInteger = ExpantaNum.TETRATED_MAX_SAFE_INTEGER;
export const _grahamsNumber = ExpantaNum.GRAHAMS_NUMBER;

// functions
export const _absoluteValue = ExpantaNum.absoluteValue;
export const _affordArithmeticSeries = ExpantaNum.affordArithmeticSeries;
export const _affordGeometricSeries = ExpantaNum.affordGeometricSeries;
export const _arrow = ExpantaNum.arrow;
export const _ceiling = ExpantaNum.ceiling; // ceil
// export const _chain = ExpantaNum.chain;
export const _choose = ExpantaNum.choose;
export const _compare = ExpantaNum.compare;
export const _cubeRoot = ExpantaNum.cubeRoot; // cbrt
export const _divide = ExpantaNum.divide; // div
export const _equalsTo = ExpantaNum.equalsTo; // eq
export const _expansion = ExpantaNum.expansion;
export const _factorial = ExpantaNum.factorial; // fact
export const _floor = ExpantaNum.floor;
export const _gamma = ExpantaNum.gamma;
export const _generalLogarithm = ExpantaNum.generalLogarithm; // log10
// export const _greaterThan = ExpantaNum.greaterThan; // gt
// export const _greaterThanOrEqualTo = ExpantaNum.greaterThanOrEqualTo; // gte
export const _hyper = ExpantaNum.hyper;
export const _isFinite = ExpantaNum.isFinite;
export const _isInfinite = ExpantaNum.isInfinite;
export const _isInteger = ExpantaNum.isInteger; // isint
export const _isNaN = ExpantaNum.isNaN;
export const _isNegative = ExpantaNum.isNegative; // isneg
export const _isPositive = ExpantaNum.isPositive; // ispos
// export const _iteratedExp = ExpantaNum.iteratedexp;
export const _iteratedLog = ExpantaNum.iteratedlog;
export const _lambertW = ExpantaNum.lambertw;
export const _layerAdd = ExpantaNum.layeradd;
export const _layerAdd10 = ExpantaNum.layeradd10;
// export const _lessThan = ExpantaNum.lessThan; // lt
// export const _lessThanOrEqualTo = ExpantaNum.lessThanOrEqualTo; // lte
export const _logarithm = ExpantaNum.logarithm; // logbase
export const _minus = ExpantaNum.minus; // sub
export const _modular = ExpantaNum.modular; // mod
export const _naturalLogarithm = ExpantaNum.naturalLogarithm; // ln, log
export const _negate = ExpantaNum.negate; // neg
// export const _notEqualTo = ExpantaNum.notEqualTo; // neq
export const _pentate = ExpantaNum.pentate; // pent
export const _plus = ExpantaNum.plus; // add
export const _reciprocate = ExpantaNum.reciprocate; // rec
export const _root = ExpantaNum.root;
export const _round = ExpantaNum.round;
export const _slog = ExpantaNum.slog;
export const _squareRoot = ExpantaNum.squareRoot; // sqrt
export const _ssqrt = ExpantaNum.ssqrt; // ssrt
export const _sumArithmeticSeries = ExpantaNum.sumArithmeticSeries;
export const _sumGeometricSeries = ExpantaNum.sumGeometricSeries;
export const _times = ExpantaNum.times; // mul
export const _tetrate = ExpantaNum.tetrate; // tetr
export const _toPower = ExpantaNum.toPower; // pow

// IO
export const _toString = function(x) {
    return x.toString();
}
export const _toExponential = function (x, places, applyToOpNums) {
    return x.toExponential(places, applyToOpNums);
}
export const _toFixed = function (x, places, applyToOpNums) {
    return x.toFixed(places, applyToOpNums);
}
export const _toHyperE = function (x) {
    return x.toHyperE;
}
export const _toJSON = function (x) {
    return x.toJSON;
}
export const _toNumber = function (x) {
    return x.toNumber;
}
export const _toPrecision = function (x, places, applyToOpNums) {
    return x.toPrecision(places, applyToOpNums);
}
export const _toStringWithDecimalPlaces = function (x, places, applyToOpNums) {
